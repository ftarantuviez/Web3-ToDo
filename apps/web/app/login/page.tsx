...
function ModelStarShip3D() {
  const gltf = useGLTF("/3d/starship/scene.gltf");
...
export default function LoginPage() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gradient-to-br from-[#00001a] to-[#000033]">
      ...
      <motion.div
        className="bg-black bg-opacity-30 backdrop-blur-lg rounded-3xl p-12 text-center text-white z-10 border border-opacity-20 border-white shadow-2xl"
